...
@Component({
  selector: 'ngx-vistors-orders-chart',
  styleUrls: ['./vistors-orders-chart.component.scss'],
  template: `
    <div class="header">
...
export class VistorsOrdersChartComponent implements AfterViewInit, OnDestroy, OnChanges {
